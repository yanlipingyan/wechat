...
namespace Alipay.API
{
    ...
    public class Config
    {
        ...
        static Config()
        {
            ...
            //收款支付宝账号
            seller_email = ConfigurationManager.AppSettings["SellerEmail"];

            //交易安全检验码，由数字和字母组成的32位字符串
            key = ConfigurationManager.AppSettings["Key"];

            //通知url
            notice_url = ConfigurationManager.AppSettings["NoticeUrl"];
        ...
        {
            get { return notice_url; }
            set { notice_url = value; }
        }
