...
namespace Wechat.API
{
    ...
    public static class Pay
    {
        ...
        /// 生成订单号
        /// </summary>
        /// <param name="mchID">微信商户平台商户号</param>
        /// <returns>订单贸易号（string）</returns>
        ...
        /// <param name="mchAPISecret">微信商户平台商户支付密钥。设置路径：微信商户平台(pay.weixin.qq.com)-->账户设置-->API安全-->密钥设置</param>
