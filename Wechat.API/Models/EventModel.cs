...
namespace Wechat.API.Models
{
    ...
    public class SubOrUnsubEventModel : BasicEventModel
    {
        public string ToXml()
        {
    ...
    public class ScanQrcodeWithParamEventModel : BasicEventModel
    {
    ...
    public class ReportLocationEventModel : BasicEventModel
    {
    ...
    public class CustomMenuEventModel : BasicEventModel
    {
    ...
    /// </summary>
    public class ClickMenuJumpLinkEventModel : BasicEventModel
    {
