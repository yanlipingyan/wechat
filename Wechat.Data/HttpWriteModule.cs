...
{
    public class HttpWriteModule : IHttpModule
    {
        public const string KEY = "NhibernateHttpWriteSession";
        ...
        private static ISessionFactory GetFactory()
        {
            if (sessionFactory == null)
            {
                ...
                config.Configure(string.Format("{0}/Config/Nhibernate/HttpWriteNHibernate.cfgl.xml", path));
